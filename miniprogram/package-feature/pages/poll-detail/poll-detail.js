...
function buildSharePath(dishes) {
  ...
  return `/package-feature/pages/poll-detail/poll-detail?${params.join("&")}`;
}
...
Page({
  ...
  onCreateAgain() {
    ...
    wx.navigateTo({
      url: city
        ? `/package-feature/pages/poll-create/poll-create?city=${encodeURIComponent(city)}`
        : "/package-feature/pages/poll-create/poll-create"
    });
  },
